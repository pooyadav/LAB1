...
pthread_cond_t cond1sum; /*create conditional variable */
...
int main(int argc, char *argv[])
{
    ...
    pthread_cond_init(&cond1sum, NULL); /*initialise conditional variable*/
